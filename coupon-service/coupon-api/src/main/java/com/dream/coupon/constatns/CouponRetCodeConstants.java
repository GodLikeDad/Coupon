/**
 * @program dream
 * @description: 用户api返回码常量
 * @author: mf
 * @create: 2019/12/16 21:04
 */

package com.dream.coupon.constatns;

public enum CouponRetCodeConstants {
    // 系统公用
    SUCCESS                             ("000000", "成功"),
    ...
    CouponRetCodeConstants(String code, String message) {
        this.code = code;
    ...
    public static String getMessage(String code) {
        for (CouponRetCodeConstants s : CouponRetCodeConstants.values()) {
            if (null == code)
                break;
